...
t1<-read_csv("../../data/indicators_deseasonalized_era5land_and_rn.csv") %>%
...
capacity_meta_subset<-full_join(capacity_factors_subset, meta_data, by=c("Location"="NOMBRE"))
...
final_tab<-full_join(final_tab, locations_subset,by = c("Installation"="Location"))
